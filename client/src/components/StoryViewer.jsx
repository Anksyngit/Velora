...
const StoryViewer = ({viewStory, setViewStory}) => {
    ...
    useEffect(()=>{
        ...
        if(viewStory && viewStory.media_type !== 'video'){
            ...
            // Close Story after duration of 10seconds 
            timer = setTimeout(()=>{
                setViewStory(null)
            },duration)
        }
    ...
    return(
        <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center" style={{ backgroundColor: viewStory.media_type === "text"? viewStory.background_color : "#000000",}}>

            {/*Progress Bar*/}
            <div className="absolute top-0 left-0 w-full h-1 bg-gray-700 pointer-events-none">
